      ...
      <section className="bg-background py-12 lg:py-16">
        <div className="px-6 lg:px-16">
          <div className="max-w-7xl mx-auto">
            <div className="flex gap-1 h-[320px] sm:h-[400px] md:h-[480px]">
          ...
          >
            {carouselItems.map((item) => (
              ...
              >
                ...
                />
                <p className="relative font-bold text-center text-[1.875rem] uppercase tracking-widest px-4 pb-7 leading-snug text-white">
                  {item.text}
                </p>
              </div>
            ))}
